...
//}
//
//func MakeErrorEndpoints(s hello.HTTPService) ErrorEndpoints {
//	return ErrorEndpoints{
//		IndexEndpoint: GetTraceEndpoint(MakeErrorIndexEndpoint(s), "error index"),
//	}
//}
//
//func MakeErrorIndexEndpoint(next hello.HTTPService) endpoint.Endpoint {
//	return func(ctx context.Context, request interface{}) (interface{}, error) {
//		req := request.(transport.HelloRequest)
